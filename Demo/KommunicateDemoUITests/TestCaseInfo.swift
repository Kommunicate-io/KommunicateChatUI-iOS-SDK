...
enum AppPermission {
    enum AlertMessage {
        static let accessNotificationInApplication = "“Kommunicate” Would Like to Send You Notifications"
        static let accessPhoto = "“Kommunicate” Would Like to Access Your Photos"
        static let accessContact = "“Kommunicate” Would Like to Access Your Contacts"
        static let accessLocation = "“Kommunicate” to access your location while you are using the app?"
    }
