//
//  KommunicateSwiftGroupSendMessageUITest.swift
//
...
class KommunicateSwiftGroupSendMessageUITest: XCTestCase {
    enum GroupData {
    ...
    private func login() {
        let path = Bundle(for: KommunicateSwiftGroupSendMessageUITest.self).url(forResource: "Info", withExtension: "plist")
