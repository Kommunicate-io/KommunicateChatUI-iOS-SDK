...
public final class KMChatNewChatViewModel {
    private var localizedStringFileName: String!

    var friendList = [KMChatContactProtocol]() // For UI presentation
    var bufferFriendList = [KMChatContactProtocol]() {
        didSet {
    ...
    func addCategorizeContacts(channel: KMCoreChannel?) {
        ...
        var friendList = [KMChatContactProtocol]()
    ...
    func fetchContactsFromDB() -> [KMChatContactProtocol]? {
        ...
        var contactList = [KMChatContactProtocol]()
        do {
    ...
    func friendForRow(indexPath: IndexPath) -> KMChatContactProtocol {
        return friendList[indexPath.row]
    }

    // Internal class
    final class CreateGroup: KMChatContactProtocol, Localizable {
    ...
    func createGroupCell() -> KMChatContactProtocol {
