//
//  KMChatPreviewImageViewModel.swift
//
//
...
final class KMChatPreviewImageViewModel: NSObject, Localizable {
    ...
    func saveImage(image: UIImage?, successBlock: @escaping () -> Void, failBlock: @escaping (Error) -> Void) {
        ...
        UIImageWriteToSavedPhotosAlbum(
            image,
            self,
            #selector(KMChatPreviewImageViewModel.image(_:didFinishSavingWithError:contextInfo:)),
            nil
        )
    }
