//
//  KMChatCreateGroupViewModel.swift
//
//
...
protocol KMChatCreateGroupViewModelDelegate: AnyObject {
    func membersFetched()
...
enum Options: String, Localizable {
    ...
    func value(
        ...
        index: Int,
        delegate: KMChatCreateGroupViewModelDelegate
    ) -> UIAlertAction {
        switch self {
        case .remove:
...
class KMChatCreateGroupViewModel: Localizable {
    ...
    weak var delegate: KMChatCreateGroupViewModelDelegate?
