//
//  KMChatVideoUploadManager.swift
...
class KMChatVideoUploadManager: NSObject {
        ...
        if let thumbnailUrl = dbMessage.fileMetaInfo.thumbnailUrl,
           !thumbnailUrl.isEmpty {
            clientService.sendPhoto(forUserInfo: alMessage.dictionary(), withCompletion: {
                ...
                let task = KMChatUploadTask(url: url, fileName: fileName)
...
extension KMChatVideoUploadManager: URLSessionDataDelegate {
