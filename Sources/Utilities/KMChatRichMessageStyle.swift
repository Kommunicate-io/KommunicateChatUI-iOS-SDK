...
// MARK: - KMChatRichMessageStyle

public enum KMChatRichMessageStyle {
    static let styles: [ColorProtocol.Type] = [
        KMChatListTemplateCell.ListStyle.self,
        KMChatGenericCardCell.CardStyle.self,
...
public extension KMChatListTemplateCell {
    ...
    struct ListStyle: ColorProtocol {
        ...
        public static func setPrimaryColor(primaryColor: UIColor) {
            KMChatListTemplateCell.ListStyle.shared.setColor(primaryColor)
        }
...
public extension KMChatGenericCardCell {
