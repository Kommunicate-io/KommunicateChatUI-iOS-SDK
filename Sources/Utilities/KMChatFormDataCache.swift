...
import Foundation
/// `KMChatFormDataCache`class will be used for form data cache
public class KMChatFormDataCache {
    public static let shared = KMChatFormDataCache()
