//
//  KMChatAppSettingsUserDefaults.swift
...
/// `KMChatAppSettingsUserDefaults` is used for handling the app settings and storing the data
public struct KMChatAppSettingsUserDefaults {
    // MARK: - Internal properties

    let navigationBarProxy = UINavigationBar.appearance(whenContainedInInstancesOf: [KMChatBaseNavigationViewController.self])

    let appSettingsKey = "KMChat_APP_SETTINGS"
    ...
    public func setAppPrimaryColorColor(color: UIColor) {
        ...
        if appSettings == nil {
            appSettings = KMChatAppSettings(primaryColor: color.toHexString())
        }
    ...
    public func getSentMessageBackgroundColor() -> UIColor {
        ...
        return KMChatMessageStyle.sentBubble.color
    }
    ...
    public func getReceivedMessageBackgroundColor() -> UIColor {
        ...
        return KMChatMessageStyle.receivedBubble.color
    }
    ...
    public func setAppSettings(appSettings: KMChatAppSettings) {
    ...
    public func updateOrSetAppSettings(appSettings: KMChatAppSettings) {
    ...
    public func getAppSettings() -> KMChatAppSettings? {
        guard let data = UserDefaults.standard.object(forKey: appSettingsKey) as? Data,
              let appSettings = try? NSKeyedUnarchiver.unarchivedObject(ofClass: KMChatAppSettings.self, from: data)
        else {
            return nil
        }
        return appSettings
    ...
    private func getDefaultAppSettings() -> KMChatAppSettings {
        guard let appSettings = getAppSettings() else {
            return KMChatAppSettings(primaryColor: UIColor.navigationOceanBlue().toHexString())
        }
        return appSettings
    }
}

/// `KMChatAppSettings`class is used for creating a app settings details
public class KMChatAppSettings: NSObject, NSSecureCoding {
