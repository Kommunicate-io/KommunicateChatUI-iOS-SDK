//
//  KMChatMessageViewModel+Extension.swift
...
extension KMChatMessageViewModel {
    ...
    func messageStatus() -> KMChatMessageStatus {
        if isAllRead {
            return .read
    ...
    func isActionButtonHidden() -> Bool {
        ...
        guard self.isSuggestedReply(),
              ...
              let lastSentMessageTime = KMChatConversationViewModel.lastSentMessage?.createdAtTime,
