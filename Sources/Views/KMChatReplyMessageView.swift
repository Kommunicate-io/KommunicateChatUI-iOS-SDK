...
open class KMChatReplyMessageView: UIView, Localizable {
    public enum Theme {
    ...
    private var message: KMChatMessageViewModel?
    ...
    init(frame: CGRect, configuration: KMChatConfiguration) {
    ...
    open func update(message: KMChatMessageViewModel) {
