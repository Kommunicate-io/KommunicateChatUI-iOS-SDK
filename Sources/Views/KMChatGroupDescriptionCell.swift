//
//  KMChatGroupDescriptionCell.swift
...
class KMChatGroupDescriptionCell: UICollectionViewCell, Localizable {
    ...
    var channelDetailConfig: KMChatChannelDetailViewConfiguration?
    ...
    func updateView(localizedStringFileName: String,
                    ...
                    channelDetailConfig: KMChatChannelDetailViewConfiguration?) {
...
class KMChatGroupHeaderTitleCell: UICollectionViewCell {
    // MARK: - Variables and Types
    ...
    static let cellID = "KMChatGroupHeaderTitleCell"
    var channelDetailConfig = KMChatChannelDetailViewConfiguration()
    var localizedStringFileName: String?
