//
//  KMChatFriendMessageQuickReplyCell.swift
...
#endif
public class KMChatFriendMessageQuickReplyCell: KMChatChatBaseCell<KMChatMessageViewModel> {
    enum ViewPadding {
        enum NameLabel {
    ...
    public func update(viewModel: KMChatMessageViewModel, maxWidth: CGFloat) {
    ...
    public class func rowHeight(viewModel: KMChatMessageViewModel, maxWidth: CGFloat) -> CGFloat {
        let isMessageEmpty = viewModel.isMessageEmpty
...
extension KMChatFriendMessageQuickReplyCell: Tappable {
