//
//  KMChatConversationNavBar.swift
...
open class KMChatConversationNavBar: UIView, Localizable {
    ...
    public required init(configuration: KMChatConfiguration, delegate: NavigationBarCallbacks) {
    ...
    func updateView(profile: KMChatConversationProfile) {
