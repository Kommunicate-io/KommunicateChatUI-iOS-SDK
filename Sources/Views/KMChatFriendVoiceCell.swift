...
class KMChatFriendVoiceCell: KMChatVoiceCell {
    ...
    override func setupStyle() {
        ...
        bubbleView.setBubbleStyle(KMChatMessageStyle.receivedBubble, isReceiverSide: true)
        soundPlayerView.setBubbleStyle(KMChatMessageStyle.receivedBubble, isReceiverSide: true)
    }
