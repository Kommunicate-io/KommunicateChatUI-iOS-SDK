...
public protocol KMChatChatViewModelProtocol {
    var avatar: URL? { get }
    ...
    var messageType: KMChatMessageType { get }
...
extension KMChatChatViewModelProtocol {
...
public enum KMChatChatCellAction {
    case delete
    case favorite
    case store
    case mute
...
public final class KMChatChatCell: SwipeTableViewCell, Localizable {
    ...
    var viewModel: KMChatChatViewModelProtocol?

    public func update(viewModel: KMChatChatViewModelProtocol, identity _: KMChatIdentityProtocol?, placeholder: UIImage? = nil) {
    ...
    private func placeholderImage(_ placeholderImage: UIImage? = nil, viewModel: KMChatChatViewModelProtocol) -> UIImage? {
    ...
    private func updateAttchmentIcon(type: KMChatMessageType) {
        switch type {
        case .location:
