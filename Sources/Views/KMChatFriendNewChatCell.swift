...
class KMChatFriendNewChatCell: UITableViewCell {
    ...
    weak var delegate: KMChatFriendCellProtocol?
    ...
    func setFriendCellDelegate(cellDelegate: KMChatFriendCellProtocol?, indexPath: IndexPath) {
        delegate = cellDelegate
        self.indexPath = indexPath
    }

    func update(friend: KMChatContactProtocol) {
        // no actual data yet
