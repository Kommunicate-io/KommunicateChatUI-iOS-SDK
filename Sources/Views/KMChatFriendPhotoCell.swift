...
class KMChatFriendPhotoCell: KMChatPhotoCell {
    ...
    override class var messageTextFont: UIFont {
        return KMChatMessageStyle.receivedMessage.font
    }

    override func setupStyle() {
        super.setupStyle()
        nameLabel.setStyle(KMChatMessageStyle.displayName)
        captionLabel.font = KMChatMessageStyle.receivedMessage.font
        captionLabel.textColor = KMChatMessageStyle.receivedMessage.text
        if KMChatMessageStyle.receivedBubble.style == .edge {
            bubbleView.layer.cornerRadius = KMChatMessageStyle.receivedBubble.cornerRadius
            bubbleView.backgroundColor = appSettingsUserDefaults.getReceivedMessageBackgroundColor()
            photoView.layer.cornerRadius = KMChatMessageStyle.receivedBubble.cornerRadius
        } else {
            photoView.layer.cornerRadius = KMChatMessageStyle.receivedBubble.cornerRadius
            bubbleView.layer.cornerRadius = KMChatMessageStyle.receivedBubble.cornerRadius
        }
