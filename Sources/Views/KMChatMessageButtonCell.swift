...
#endif
open class KMChatMyMessageButtonCell: KMChatChatBaseCell<KMChatMessageViewModel> {
    enum ViewPadding {
        enum StateView {
    ...
    open func update(viewModel: KMChatMessageViewModel, maxWidth: CGFloat) {
...
class KMChatFriendMessageButtonCell: KMChatChatBaseCell<KMChatMessageViewModel> {
    enum ViewPadding {
        enum NameLabel {
...
extension KMChatFriendMessageButtonCell: Tappable {
