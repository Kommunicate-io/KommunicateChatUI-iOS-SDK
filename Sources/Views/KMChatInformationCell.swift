...
final class KMChatInformationCell: UITableViewCell, Localizable {
    ...
    func setConfiguration(configuration: KMChatConfiguration) {
    ...
    class func rowHeigh(viewModel: KMChatMessageViewModel, width _: CGFloat) -> CGFloat {
        ...
        if let message = viewModel.message {
            ...
            let rect = (nomalizedMessage as NSString).boundingRect(
                ...
                attributes: [NSAttributedString.Key.font: KMChatMessageStyle.infoMessage.font],
                context: nil
            )
            //  Get feedback dictionary for view
            if let feedback = KMChatInformationCell().getFeedback(viewModel: viewModel),
               let comment = feedback["comments"] as? String {
                ...
                let commentBoundingRect = (normalizedComment as NSString).boundingRect(
                    ...
                    attributes: [.font: KMChatMessageStyle.infoMessage.font],
                    context: nil
                )
    ...
    fileprivate var viewModel: KMChatMessageViewModel?

    func update(viewModel: KMChatMessageViewModel) {
    ...
    fileprivate func getFormattedFeedbackString(_ viewModel: KMChatMessageViewModel) -> NSMutableAttributedString {
    ...
    fileprivate func setupConstraints() {
        ...
        bubbleView.backgroundColor = KMChatMessageStyle.infoMessage.background
        messageView.setFont(KMChatMessageStyle.infoMessage.font)
    ...
    fileprivate func setupSummaryConstraints() {
        ...
        summaryMessageView.font = KMChatMessageStyle.summaryMessage.font
    ...
    fileprivate func setupConstraintsForAssignedTo() {
        ...
        assignTextView.setFont(KMChatMessageStyle.assignmentMessage.font)
        assignTextView.setTextColor(KMChatMessageStyle.assignmentMessage.text)
        contentView.backgroundColor = UIColor.clear
        backgroundColor = UIColor.clear
    }
    ...
    func setupStyle() {
        ...
        messageView.setFont(KMChatMessageStyle.feedbackMessage.font)
        messageView.textColor = KMChatMessageStyle.feedbackMessage.text
        commentTextView.setFont(KMChatMessageStyle.feedbackComment.font)
        commentTextView.textColor = KMChatMessageStyle.feedbackComment.text
    }
    
    func getFeedback(viewModel: KMChatMessageViewModel) -> [String: Any]? {
