...
class KMChatEmailTopView: UIView {
    ...
    private func setupConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            emailImage.heightAnchor.constraint(equalToConstant: KMChatEmailTopView.height),
            emailImage.widthAnchor.constraint(equalToConstant: KMChatEmailTopView.height),
            ...
            emailLabel.heightAnchor.constraint(equalToConstant: KMChatEmailTopView.height)
        ])
    }
}

class KMChatEmailBottomView: UIView {
    enum Padding {
        enum View {
            static let height: CGFloat = 20
        }
