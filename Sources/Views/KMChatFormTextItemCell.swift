...
class KMChatFormTextItemCell: UITableViewCell {
...
class KMChatFormTextAreaItemCell: UITableViewCell {
    var item: FormViewModelItem? {
        didSet {
...
class KMChatFormItemHeaderView: UITableViewHeaderFooterView {
    var item: FormViewModelItem? {
        didSet {
