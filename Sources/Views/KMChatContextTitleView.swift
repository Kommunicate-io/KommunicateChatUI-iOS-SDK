...
public protocol KMChatContextTitleViewType {
    func configureWith(value: KMChatContextTitleDataType)
    func setupUI()
}

open class KMChatContextTitleView: UIView, KMChatContextTitleViewType {
    private var viewModel: KMChatContextTitleViewModelType?
    ...
    public func configureWith(value data: KMChatContextTitleDataType) {
        viewModel = KMChatContextTitleViewModel(data: data)
        setupUI()
    }
