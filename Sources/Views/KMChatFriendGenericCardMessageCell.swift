//
//  KMChatFriendGenericCardCell.swift
...
#endif
open class KMChatFriendGenericCardMessageCell: KMChatGenericCardBaseCell {
    enum ViewPadding {
        enum NameLabel {
    ...
    override func setupViews() {
        ...
        collectionView.topAnchor.constraint(equalTo: messageView.bottomAnchor, constant: KMChatFriendGenericCardMessageCell.cardTopPadding).isActive = true
    ...
    override open class func rowHeigh(viewModel: KMChatMessageViewModel, width: CGFloat) -> CGFloat {
        let isMessageEmpty = viewModel.isMessageEmpty
