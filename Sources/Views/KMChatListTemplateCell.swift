...
// MARK: - `KMChatMyMessageListTemplateCell` for sender side.

public class KMChatMyMessageListTemplateCell: KMChatListTemplateCell {
    enum ViewPadding {
        enum StateView {
    ...
    override public func update(viewModel: KMChatMessageViewModel, maxWidth: CGFloat) {
    ...
    override public class func rowHeight(viewModel: KMChatMessageViewModel, maxWidth: CGFloat) -> CGFloat {
...
// MARK: - `KMChatFriendMessageListTemplateCell` for receiver side.

public class KMChatFriendMessageListTemplateCell: KMChatListTemplateCell {
    enum ViewPadding {
        enum NameLabel {
    ...
    override public class func rowHeight(viewModel: KMChatMessageViewModel,
    ...
    override func setupConstraints() {
        ...
        let width = CGFloat(KMChatMessageStyle.receivedBubble.widthPadding)
...
// MARK: - `KMChatListTemplateCell`

public class KMChatListTemplateCell: KMChatChatBaseCell<KMChatMessageViewModel> {
    ...
    public func update(viewModel: KMChatMessageViewModel, maxWidth _: CGFloat) {
    ...
    public class func rowHeight(viewModel: KMChatMessageViewModel, maxWidth _: CGFloat) -> CGFloat {
        guard let metadata = viewModel.metadata,
              var template = try? TemplateDecoder.decode(KMListTemplate.self, from: metadata)
        else {
            return CGFloat(0)
