...
public protocol KMChatAudioRecorderViewProtocol: AnyObject {
    func cancelAudioRecording()
}

open class KMChatAudioRecorderView: UIView, Localizable {
    ...
    weak var delegate: KMChatAudioRecorderViewProtocol?
    ...
    func setAudioRecViewDelegate(recorderDelegate: KMChatAudioRecorderViewProtocol?) {
    ...
    public init(frame: CGRect, configuration: KMChatConfiguration) {
