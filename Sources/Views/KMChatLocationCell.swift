...
protocol KMChatLocationCellDelegate: AnyObject {
    func displayLocation(location: KMChatLocationPreviewViewModel)
}

class KMChatLocationCell: KMChatChatBaseCell<KMChatMessageViewModel>,
    KMChatReplyMenuItemProtocol, KMChatReportMessageMenuItemProtocol {
    weak var delegate: KMChatLocationCellDelegate?
    ...
    override func update(viewModel: KMChatMessageViewModel) {
        ...
        guard let apiKey = KMCoreUserDefaultsHandler.getGoogleMapAPIKey() else {
    ...
    func setDelegate(locDelegate: KMChatLocationCellDelegate) {
    ...
    // MARK: - KMChatPreviewLocationViewControllerDelegate

    func locationPreviewViewModel() -> KMChatLocationPreviewViewModel {
        guard let loc = tempLocation else {
            ...
            return KMChatLocationPreviewViewModel(addressText: unspecifiedLocaltionMsg, localizedStringFileName: localizedStringFileName)
        }
        return KMChatLocationPreviewViewModel(geocode: loc, localizedStringFileName: localizedStringFileName)
    }
...
class KMChatTappableView: UIView {
