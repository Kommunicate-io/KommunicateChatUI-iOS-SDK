...
// MARK: - KMChatPhotoCell

class KMChatPhotoCell: KMChatChatBaseCell<KMChatMessageViewModel>,
    ...
    // To be changed from the class that is subclassing `KMChatPhotoCell`
    ...
    override func setupViews() {
        ...
        uploadButton.addTarget(self, action: #selector(KMChatPhotoCell.uploadButtonAction(_:)), for: .touchUpInside)
        ...
        downloadButton.addTarget(self, action: #selector(KMChatPhotoCell.downloadButtonAction(_:)), for: .touchUpInside)
        ...
        captionLabel.layout {
            ...
            $0.bottom == contentView.bottomAnchor - KMChatPhotoCell.bottomPadding()
        }
    }
...
extension KMChatPhotoCell: KMChatHTTPManagerUploadDelegate {
...
extension KMChatPhotoCell: KMChatHTTPManagerDownloadDelegate {
