...
//            if let vc = presenterVC, let delegate = vc as? ALKShareLocationViewControllerDelegate {
...
//            }
    ...
    func setPresenterVC<T: UIViewController>(delegate: T) where T: ALKShareLocationViewControllerDelegate {
