...
#endif
class KMChatLinkPreviewBaseCell: KMChatMessageCell {
    var url: String?
    let linkView = KMChatLinkView()
    ...
    override func update(
        ...
        url = KMChatLinkPreviewManager.extractURLAndAddInCache(from: viewModel.message, identifier: viewModel.identifier)?.absoluteString
...
extension KMChatLinkPreviewBaseCell: UITextViewDelegate {
