...
#endif
class KMChatLinkView: UIView, Localizable {
    enum CommonPadding {
        enum View {
    ...
    var frontView: KMChatTappableView = {
    ...
    func update(url: String?, identifier: String) {
        ...
        guard let cachelinkPreviewMeta = KMLinkURLCache.getLink(for: linkUrl) else {
            ...
            let linkview = KMChatLinkPreviewManager()
    ...
    class func height() -> CGFloat {
        return KMChatLinkView.CommonPadding.View.height + KMChatLinkView.CommonPadding.PreviewImageView.top
    }
