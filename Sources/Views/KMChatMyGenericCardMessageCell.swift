//
//  KMChatMyGenericCardMessageCell.swift
...
#endif
open class KMChatMyGenericCardMessageCell: KMChatGenericCardBaseCell {
    enum ViewPadding {
        enum StateView {
    ...
    override open func update(viewModel: KMChatMessageViewModel, width: CGFloat) {
    ...
    override func setupViews() {
        ...
        let width = CGFloat(KMChatMessageStyle.sentBubble.widthPadding)
        ...
        collectionView.topAnchor.constraint(equalTo: messageView.bottomAnchor, constant: KMChatGenericCardBaseCell.cardTopPadding).isActive = true
    ...
    override public class func rowHeigh(viewModel: KMChatMessageViewModel, width: CGFloat) -> CGFloat {
    ...
    private func setupCollectionView() {
        ...
        collectionView = KMChatGenericCardCollectionView(frame: .zero, collectionViewLayout: layout)
        collectionView.showsHorizontalScrollIndicator = false
        collectionView.backgroundColor = .clear
    }
}

open class KMChatGenericCardBaseCell: KMChatChatBaseCell<KMChatMessageViewModel> {
    open var collectionView: KMChatGenericCardCollectionView!
    ...
    open func update(viewModel: KMChatMessageViewModel, width: CGFloat) {
        self.viewModel = viewModel
        super.update(viewModel: viewModel)

        collectionView.setMessage(viewModel: viewModel)
        collectionView.reloadData()
        let collectionViewHeight = KMChatGenericCardCollectionView.rowHeightFor(message: viewModel, width: width)
    ...
    public class func cardHeightFor(message: KMChatMessageViewModel, width: CGFloat) -> CGFloat {
        let cardHeight = KMChatGenericCardCollectionView.rowHeightFor(message: message, width: width)
