//
//  KMChatPreviewPhotoViewController.swift
...
final class KMChatPreviewPhotoViewController: KMChatBaseViewController {
    ...
    convenience init(configuration: KMChatConfiguration, image: UIImage) {
...
extension KMChatPreviewPhotoViewController: UIScrollViewDelegate {
