//
//  KMChatGroupDescriptionController.swift
...
protocol KMChatGroupDescriptionDelegate: AnyObject {
    func onGroupDescriptionSave(description: String)
}

// MARK: Group description ViewController

class KMChatGroupDescriptionController: KMChatBaseViewController, Localizable {
    ...
    var groupDescriptionViewModel: KMChatGroupDescriptionViewModel?
    weak var delegate: KMChatGroupDescriptionDelegate?
    ...
    override func viewDidLoad() {
        ...
        groupDescriptionViewModel = KMChatGroupDescriptionViewModel(channelKey: channelKey)
    ...
    func update(groupDescriptionViewModel: KMChatGroupDescriptionViewModel?) {
...
extension KMChatGroupDescriptionController: UITextViewDelegate {
