//
//  KMChatConversationViewController+UIImagePicker.swift
...
extension KMChatConversationViewController:
            ...
            viewModel.encodeVideo(videoURL: url, completion: {
                ...
                DispatchQueue.main.async {
                    ...
                    guard let newIndexPath = indexPath,
                          let cell = self.tableView.cellForRow(at: newIndexPath) as? KMChatMyVideoCell else { return }
