//
//  KMChatAlertViewController.swift
...
class KMChatAlertViewController: UIViewController, Localizable {
    public enum Action {
    ...
    init(action: String, delegate: ALAlertButtonClickProtocol, messageKey: String, configuration: KMChatConfiguration) {
