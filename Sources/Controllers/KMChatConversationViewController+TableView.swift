//
//  KMChatConversationViewController+TableView.swift
...
extension KMChatConversationViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    private func necessarySetupForMessageCell(cell: KMChatMessageCell, message: KMChatMessageViewModel) {
    ...
    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case .text, .html, .email:
            if !configuration.isLinkPreviewDisabled, message.messageType == .text, KMChatLinkPreviewManager.extractURLAndAddInCache(from: message.message, identifier: message.identifier) != nil {
                var cell = KMChatLinkPreviewBaseCell()
                if message.isMyMessage {
                    cell = tableView.dequeueReusableCell(forIndexPath: indexPath) as KMChatMyLinkPreviewCell
                    ...
                    cell = tableView.dequeueReusableCell(forIndexPath: indexPath) as KMChatFriendLinkPreviewCell
                    cell.menuOptionsToShow = configuration.messageMenuOptions
                ...
                if message.isMyMessage {
                    let cell = tableView.dequeueReusableCell(forIndexPath: indexPath) as KMChatMyMessageCell
                    cell.menuOptionsToShow = configuration.messageMenuOptions
                    cell.showReport = false
                    necessarySetupForMessageCell(cell: cell, message: message)
                    return cell
                } else {
                    let cell = tableView.dequeueReusableCell(forIndexPath: indexPath) as KMChatFriendMessageCell
                    cell.menuOptionsToShow = configuration.messageMenuOptions
                    cell.showReport = true
                    cell.avatarTapped = { [weak self] in
                        guard let currentModel = cell.viewModel else { return }
        ...
        case .photo:
            if message.isMyMessage {
                ...
                if message.ratio < 1 {
                    ...
                    let cell: KMChatMyPhotoPortalCell = tableView.dequeueReusableCell(forIndexPath: indexPath)
                    ...
                    let cell: KMChatMyPhotoLandscapeCell = tableView.dequeueReusableCell(forIndexPath: indexPath)
                    cell.menuOptionsToShow = configuration.messageMenuOptions
                    cell.showReport = false
                    cell.setLocalizedStringFileName(configuration.localizedStringFileName)
                    cell.update(viewModel: message)
                ...
                if message.ratio < 1 {
                    let cell: KMChatFriendPhotoPortalCell = tableView.dequeueReusableCell(forIndexPath: indexPath)
                    cell.setLocalizedStringFileName(configuration.localizedStringFileName)
                    cell.menuOptionsToShow = configuration.messageMenuOptions
                    cell.showReport = true
                    cell.update(viewModel: message)
                    ...
                    let cell: KMChatFriendPhotoLandscapeCell = tableView.dequeueReusableCell(forIndexPath: indexPath)
                    cell.menuOptionsToShow = configuration.messageMenuOptions
                    cell.showReport = true
                    cell.menuAction = { [weak self] action in
                        self?.menuItemSelected(action: action, message: message)
        ...
        case .voice:
            ...
            if message.isMyMessage {
                let cell: KMChatMyVoiceCell = tableView.dequeueReusableCell(forIndexPath: indexPath)
                cell.menuOptionsToShow = configuration.messageMenuOptions
                cell.showReport = false
                cell.setLocalizedStringFileName(configuration.localizedStringFileName)
                ...
                let cell: KMChatFriendVoiceCell = tableView.dequeueReusableCell(forIndexPath: indexPath)
                cell.menuOptionsToShow = configuration.messageMenuOptions
                cell.showReport = true
                cell.setLocalizedStringFileName(configuration.localizedStringFileName)
                cell.downloadTapped = { [weak self] _ in
        ...
        case .location:
            if message.isMyMessage {
                let cell: KMChatMyLocationCell = tableView.dequeueReusableCell(forIndexPath: indexPath)
                cell.menuOptionsToShow = configuration.messageMenuOptions
                cell.showReport = false
                cell.setLocalizedStringFileName(configuration.localizedStringFileName)
                cell.update(viewModel: message)
                ...
                let cell: KMChatFriendLocationCell = tableView.dequeueReusableCell(forIndexPath: indexPath)
                cell.setLocalizedStringFileName(configuration.localizedStringFileName)
                cell.menuOptionsToShow = configuration.messageMenuOptions
                cell.showReport = true
                cell.update(viewModel: message)
        ...
        case .information:
            let cell: KMChatInformationCell = tableView.dequeueReusableCell(forIndexPath: indexPath)
            cell.setConfiguration(configuration: configuration)
            cell.update(viewModel: message)
            return cell
        case .video:
            if message.isMyMessage {
                let cell: KMChatMyVideoCell = tableView.dequeueReusableCell(forIndexPath: indexPath)
                cell.menuOptionsToShow = configuration.messageMenuOptions
                cell.showReport = false
                cell.setLocalizedStringFileName(configuration.localizedStringFileName)
                cell.update(viewModel: message)
                ...
                let cell: KMChatFriendVideoCell = tableView.dequeueReusableCell(forIndexPath: indexPath)
                cell.setLocalizedStringFileName(configuration.localizedStringFileName)
                cell.menuOptionsToShow = configuration.messageMenuOptions
                cell.showReport = true
                cell.update(viewModel: message)
        ...
        case .cardTemplate:
            ...
            if message.isMyMessage {
                let cell = tableView.dequeueReusableCell(forIndexPath: indexPath) as KMChatMyGenericCardMessageCell
                cell.menuOptionsToShow = configuration.messageMenuOptions
                cell.showReport = false
                cell.setLocalizedStringFileName(configuration.localizedStringFileName)
                cell.register(cell: KMChatGenericCardCell.self)
                ...
                let cell = tableView.dequeueReusableCell(forIndexPath: indexPath) as KMChatFriendGenericCardMessageCell
                cell.menuOptionsToShow = configuration.messageMenuOptions
                cell.showReport = true
                cell.setLocalizedStringFileName(configuration.localizedStringFileName)
                cell.register(cell: KMChatGenericCardCell.self)
        ...
        case .quickReply:
            if message.isMyMessage {
                let cell: KMChatMyMessageQuickReplyCell = tableView.dequeueReusableCell(forIndexPath: indexPath)
                cell.setLocalizedStringFileName(configuration.localizedStringFileName)
                cell.update(viewModel: message, maxWidth: UIScreen.main.bounds.width)
                cell.update(chatBar: chatBar)
                return cell
            } else {
                let cell: KMChatFriendMessageQuickReplyCell = tableView.dequeueReusableCell(forIndexPath: indexPath)
                cell.setLocalizedStringFileName(configuration.localizedStringFileName)
                cell.update(viewModel: message, maxWidth: UIScreen.main.bounds.width)
                cell.update(chatBar: chatBar)
        ...
        case .button:
            if message.isMyMessage {
                let cell: KMChatMyMessageButtonCell = tableView.dequeueReusableCell(forIndexPath: indexPath)
                cell.setLocalizedStringFileName(configuration.localizedStringFileName)
                cell.update(viewModel: message, maxWidth: UIScreen.main.bounds.width)
                cell.update(chatBar: chatBar)
                return cell
            } else {
                let cell: KMChatFriendMessageButtonCell = tableView.dequeueReusableCell(forIndexPath: indexPath)
                cell.setLocalizedStringFileName(configuration.localizedStringFileName)
                cell.update(viewModel: message, maxWidth: UIScreen.main.bounds.width)
                cell.update(chatBar: chatBar)
        ...
        case .listTemplate:
            if message.isMyMessage {
                let cell = tableView.dequeueReusableCell(forIndexPath: indexPath) as KMChatMyMessageListTemplateCell
                cell.setLocalizedStringFileName(configuration.localizedStringFileName)
                cell.update(viewModel: message, maxWidth: UIScreen.main.bounds.width)
                ...
                let cell = tableView.dequeueReusableCell(forIndexPath: indexPath) as KMChatFriendMessageListTemplateCell
                cell.setLocalizedStringFileName(configuration.localizedStringFileName)
                cell.update(viewModel: message, maxWidth: UIScreen.main.bounds.width)
                cell.update(chatBar: chatBar)
                cell.templateSelected = { [weak self] element, defaultText, action in
        ...
        case .document:
            if message.isMyMessage {
                let cell: KMChatMyDocumentCell = tableView.dequeueReusableCell(forIndexPath: indexPath)
                cell.setLocalizedStringFileName(configuration.localizedStringFileName)
                cell.menuOptionsToShow = configuration.messageMenuOptions
                cell.showReport = false
                cell.update(viewModel: message)
                ...
                let cell: KMChatFriendDocumentCell = tableView.dequeueReusableCell(forIndexPath: indexPath)
                cell.menuOptionsToShow = configuration.messageMenuOptions
                cell.showReport = true
                cell.setLocalizedStringFileName(configuration.localizedStringFileName)
                cell.update(viewModel: message)
        ...
        case .form:
            ...
            if message.isMyMessage {
                let cell: KMChatMyFormCell = tableView.dequeueReusableCell(forIndexPath: indexPath)
                cell.setLocalizedStringFileName(configuration.localizedStringFileName)
                ...
                let cell: KMChatFriendFormCell = tableView.dequeueReusableCell(forIndexPath: indexPath)
                cell.setLocalizedStringFileName(configuration.localizedStringFileName)
                cell.updateConfiguration(configuration)
                cell.activeTextFieldChanged = { textField in
                    self.activeTextField = textField
    ...
    public func tableView(_: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        let dateView = KMChatDateSectionHeaderView.instanceFromNib()
    ...
    public func tableView(_: UITableView, willDisplay cell: UITableViewCell, forRowAt indexPath: IndexPath) {
        ...
        if message.messageType == .cardTemplate {
            if message.isMyMessage {
                guard let cell = cell as? KMChatMyGenericCardMessageCell else {
                    return
                }
                ...
                guard let cell = cell as? KMChatFriendGenericCardMessageCell else {
                    return
                }
                cell.setCollectionViewDataSourceDelegate(dataSourceDelegate: self, indexPath: indexPath)
                let index = cell.collectionView.tag
...
extension KMChatConversationViewController: UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    public func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection _: Int) -> Int {
        ...
        guard collectionView.isKind(of: KMChatIndexedCollectionView.self),
              let template = KMChatGenericCardCollectionView.getCardTemplate(message: message)
        else {
            return 0
        }
    ...
    public func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        guard let collectionView = collectionView as? KMChatIndexedCollectionView
        else {
        ...
        let cell: KMChatGenericCardCell = collectionView.dequeueReusableCell(forIndexPath: indexPath)
    ...
    public func collectionView(_ collectionView: UICollectionView, layout _: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        ...
        if message.messageType == .cardTemplate {
            ...
            let height = KMChatGenericCardCell.rowHeight(card: template[indexPath.row], maxWidth: width)
...
extension ALTopicDetail: KMChatContextTitleDataType {
