//
//  KMChatCustomCameraPreviewViewController.swift
...
final class KMChatCustomCameraPreviewViewController: KMChatBaseViewController, Localizable {
    ...
    static func instance(with image: UIImage) -> KMChatCustomCameraPreviewViewController {
        let viewController: KMChatCustomCameraPreviewViewController = UIStoryboard(storyboard: .camera).instantiateViewController()
    ...
    func setSelectedImage(pickImage: UIImage, camDelegate: KMChatCustomCameraProtocol?) {
        image = pickImage
...
extension KMChatCustomCameraPreviewViewController: UIScrollViewDelegate {
