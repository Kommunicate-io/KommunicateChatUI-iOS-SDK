//
//  KMChatDocumentViewerController.swift
...
class KMChatDocumentViewerController: UIViewController, WKNavigationDelegate {
    ...
    override func viewDidLoad() {
        ...
        view = webView
        fileUrl = KMChatFileUtils().getDocumentDirectory(fileName: filePath)
