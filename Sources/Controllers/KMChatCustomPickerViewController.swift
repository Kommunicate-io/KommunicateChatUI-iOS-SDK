//
//  KMChatCustomPickerViewController.swift
...
protocol KMChatCustomPickerDelegate: AnyObject {
    func filesSelected(images: [UIImage], gifs: [String], videos: [String], caption: String)
}

class KMChatCustomPickerViewController: KMChatBaseViewController, Localizable {
    // photo library
    var asset: PHAsset!
    ...
    weak var delegate: KMChatCustomPickerDelegate?
    ...
    static func makeInstanceWith(delegate: KMChatCustomPickerDelegate, and configuration: KMChatConfiguration) -> KMChatBaseNavigationViewController? {
        ...
        guard
            ...
            let cameraVC = vc.viewControllers.first as? KMChatCustomPickerViewController else { return nil }
...
extension KMChatCustomPickerViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
...
extension KMChatCustomPickerViewController: KMCustomUploadCaptionDelegate {
