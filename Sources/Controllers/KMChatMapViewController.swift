...
protocol KMChatShareLocationViewControllerDelegate: AnyObject {
    func locationDidSelected(geocode: Geocode, image: UIImage)
}

class KMChatMapViewController: UIViewController, Localizable {
    ...
    weak var delegate: KMChatShareLocationViewControllerDelegate?
...
//        mapView.delegate = self
    ...
    public func setConfiguration(_ configuration: KMChatConfiguration) {
        self.configuration = configuration
    }
}

extension KMChatMapViewController: CLLocationManagerDelegate {
