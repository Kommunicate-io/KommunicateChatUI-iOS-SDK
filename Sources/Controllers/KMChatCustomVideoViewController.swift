//
//  KMChatCustomVideoViewController.swift
...
final class KMChatCustomVideoViewController: KMChatBaseViewController, Localizable {
    // delegate
...
//    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender _: Any?) {
        ...
        if let customCameraPreviewVC = destination as? KMChatCustomVideoPreviewViewController {
...
extension KMChatCustomVideoViewController: AVCaptureFileOutputRecordingDelegate {
