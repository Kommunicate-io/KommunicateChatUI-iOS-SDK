...
class KMChatReplyController: UIViewController, Localizable {
    ...
    private let attachmentView = KMChatAttatchmentView(frame: .zero)
    ...
    init(messageKey: String, configuration: KMChatConfiguration) {
