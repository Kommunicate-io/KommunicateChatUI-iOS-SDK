//
//  KMChatCustomVideoPreviewViewController.swift
...
final class KMChatCustomVideoPreviewViewController: KMChatBaseViewController, Localizable {
    ...
    static func instance(with path: String) -> KMChatCustomVideoPreviewViewController {
        let viewController: KMChatCustomVideoPreviewViewController = UIStoryboard(storyboard: .video).instantiateViewController()
