//
//  KMChatAccountSuspensionController.swift
...
public class KMChatAccountSuspensionController: UIViewController, Localizable {
    ...
    func setupMessageLabel() {
        ...
        let currentPlan = userDefaults.string(forKey: KMChatAccountSuspensionController.CurrentActivatedPlan) ?? ""
    ...
    private func setupViews() {
        ...
        guard let accountView = Bundle.km.loadNibNamed("KMChatAccountSuspensionView", owner: self, options: nil)?.first as? UIView else {
            return
        }
