//
//  KMChatCustomCameraViewController.swift
...
enum KMChatCameraPhotoType {
    case noCropOption
    case cropOption
}

enum KMChatCameraType {
    case front
    case back
}

var camera = KMChatCameraType.back

protocol KMChatCustomCameraProtocol: AnyObject {
    func customCameraDidTakePicture(cropedImage: UIImage)
}

final class KMChatCustomCameraViewController: KMChatBaseViewController, AVCapturePhotoCaptureDelegate, Localizable {
    // delegate
    weak var customCamDelegate: KMChatCustomCameraProtocol?
    var camera = KMChatCameraType.back
    ...
    var cameraMode: KMChatCameraPhotoType = .noCropOption
    ...
    fileprivate lazy var activityIndicator = KMChatActivityIndicator(
        frame: .zero,
    ...
    static func makeInstanceWith(delegate: KMChatCustomCameraProtocol, and configuration: KMChatConfiguration) -> KMChatBaseNavigationViewController? {
        ...
        guard
            ...
            as? KMChatBaseNavigationViewController,
            let cameraVC = vc.viewControllers.first as? KMChatCustomCameraViewController else { return nil }
    ...
    func photoOutput(_: AVCapturePhotoOutput, didFinishProcessingPhoto photo: AVCapturePhoto, error: Error?) {
        if let error = error {
            ...
            default:
                performSegue(withIdentifier: "pushToKMChatCustomCameraPreviewViewController", sender: nil)
            }
        }
    }
    ...
    func setCustomCamDelegate(camMode: KMChatCameraPhotoType, camDelegate: KMChatCustomCameraProtocol) {
        cameraMode = camMode
    ...
    override func prepare(for segue: UIStoryboardSegue, sender _: Any?) {
        ...
        if let cropView = destination as? KMChatCustomCropImageViewController {
            cropView.configuration = configuration
            cropView.setSelectedImage(pickImage: selectedImage, camDelegate: customCamDelegate)

        } else if let customCameraPreviewVC = destination as? KMChatCustomCameraPreviewViewController {
...
extension KMChatCustomCameraViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        PHCachingImageManager.default().requestImageDataAndOrientation(
            ...
            default:
                self.performSegue(withIdentifier: "pushToKMChatCustomCameraPreviewViewController", sender: nil)
            }
        }
    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "KMChatPhotoCollectionCell", for: indexPath) as! KMChatPhotoCollectionCell
...
extension KMChatCustomCameraViewController {
