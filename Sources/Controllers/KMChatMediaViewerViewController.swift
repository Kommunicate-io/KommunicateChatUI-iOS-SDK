//
//  KMChatMediaViewerViewController.swift
...
final class KMChatMediaViewerViewController: UIViewController {
    // to be injected
    var viewModel: KMChatMediaViewerViewModel?
    ...
    fileprivate func setupView() {
        ...
        playButton.addTarget(self, action: #selector(KMChatMediaViewerViewController.playButtonAction(_:)), for: .touchUpInside)
        audioPlayButton.addTarget(self, action: #selector(KMChatMediaViewerViewController.audioPlayButtonAction(_:)), for: .touchUpInside)
        let swipeRight = UISwipeGestureRecognizer(target: self, action: #selector(KMChatMediaViewerViewController.swipeRightAction)) // put : at the end of method name
        ...
        let swipeLeft = UISwipeGestureRecognizer(target: self, action: #selector(KMChatMediaViewerViewController.swipeLeftAction))
    ...
    func showPhotoView(message: KMChatMessageViewModel) {
    ...
    func showVideoView(message: KMChatMessageViewModel) {
        guard let filePath = message.filePath,
    ...
    func showAudioView(message _: KMChatMessageViewModel) {
        imageView.image = nil
    ...
    fileprivate func updateView(message: KMChatMessageViewModel) {
...
extension KMChatMediaViewerViewController: KMChatMediaViewerViewModelDelegate {
    func reloadView() {
        guard let message = viewModel?.getMessageForCurrentIndex() else { return }
        updateView(message: message)
    }
...
extension KMChatMediaViewerViewController: UIScrollViewDelegate {
