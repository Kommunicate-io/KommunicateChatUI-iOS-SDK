//
//  KMChatConversationListTableViewController.swift
 ...
 */
public protocol KMChatConversationListTableViewDelegate: AnyObject {
    /// Tells the delegate which chat cell is tapped alongwith the position.
    func tapped(_ chat: KMChatChatViewModelProtocol, at index: Int)
...
/**
 ...
 It uses KMChatChatCell and EmptyChatCell as tableview cell and handles the swipe interaction of user with the chat cell.
 */
// swiftlint:disable:next type_name
public class KMChatConversationListTableViewController: UITableViewController, Localizable {
    ...
    public weak var delegate: KMChatConversationListTableViewDelegate?

    // MARK: - PRIVATE PROPERTIES

    fileprivate var configuration: KMChatConfiguration
     ...
     */
    public init(viewModel: KMChatConversationListViewModelProtocol,
                dbService: KMCoreMessageDBService,
                configuration: KMChatConfiguration,
                showSearch: Bool) {
    ...
    public func replaceViewModel(_ viewModel: KMChatConversationListViewModelProtocol) {
        self.viewModel = viewModel
    ...
    override public func viewDidLoad() {
        ...
        tableView.register(KMChatChatCell.self, forCellReuseIdentifier: "cell")
        tableView.register(
            KMChatEmptyView.nib,
            forHeaderFooterViewReuseIdentifier:
            KMChatEmptyView.reuseIdentifier
        )
    ...
    override public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if searchActive {
            ...
            let cell: KMChatChatCell = tableView.dequeueReusableCell(withIdentifier: "cell", for: indexPath) as! KMChatChatCell
    ...
    override public func tableView(_: UITableView, viewForFooterInSection _: Int) -> UIView? {
        guard !hideNoConversationView,
              let emptyCellView = tableView.dequeueReusableHeaderFooterView(withIdentifier: KMChatEmptyView.reuseIdentifier) as? KMChatEmptyView
        else {
            return nil
        }
...
extension KMChatConversationListTableViewController: UISearchResultsUpdating, UISearchBarDelegate {
...
// MARK: - KMChatChatCell Actions

extension KMChatConversationListTableViewController {
    // swiftlint:disable:next cyclomatic_complexity function_body_length
    public func chatCellAction(indexPath: IndexPath, action: KMChatChatCellAction, viewModel _: KMChatChatViewModelProtocol) {
        switch action {
        case .delete:
...
extension KMChatConversationListTableViewController: Muteable {
...
public extension KMChatConversationListTableViewController {
...
extension KMChatConversationListTableViewController: SwipeTableViewCellDelegate {
    ...
    private func isConversationMuted(viewModel: KMChatChatViewModelProtocol) -> Bool {
