//
//  KMChatChatBarConfiguration.swift
...
public struct KMChatChatBarConfiguration {
...
extension KMChatChatBarConfiguration.AttachmentOptions: Equatable {
    public static func == (lhs: KMChatChatBarConfiguration.AttachmentOptions, rhs: KMChatChatBarConfiguration.AttachmentOptions) -> Bool {
        switch (lhs, rhs) {
        case (.none, .none):
            return true
        case (.all, .all):
