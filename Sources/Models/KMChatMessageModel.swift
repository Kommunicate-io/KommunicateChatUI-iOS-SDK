...
public enum KMChatMessageType: String {
    case text = "Text"
    case photo = "Photo"
    case voice = "Audio"
...
public protocol KMChatMessageViewModel {
    ...
    var voiceCurrentState: KMChatVoiceCellState { get set }
...
public class KMChatMessageModel: KMChatMessageViewModel {
    public var contentType = Message.ContentType.text
    public var message: String? = ""
    public var isMyMessage: Bool = false
    public var messageType: KMChatMessageType = .text
    ...
    public var voiceCurrentState: KMChatVoiceCellState = .stop
...
extension KMChatMessageModel: Equatable {
    public static func == (lhs: KMChatMessageModel, rhs: KMChatMessageModel) -> Bool {
        return lhs.identifier == rhs.identifier
    }
}

extension KMChatMessageViewModel {
...
public extension KMChatMessageViewModel {
    var status: KMChatMessageStatus {
        if isAllRead {
            return .read
