...
public struct KMChatConfiguration {
    ...
    /// The background color of the KMChatConversationViewController.
    public var backgroundColor = UIColor(netHex: 0xF9F9F9)
    
    /// The dark background color of the KMChatConversationViewController.
    ...
    /// For the disabling of form post-submit, the form will not be editable after submission. By default, it's set to false.
    ...
    public var statusBarStyle: UIStatusBarStyle = .lightContent {
        didSet {
            KMChatBaseNavigationViewController.statusBarStyle = statusBarStyle
        }
    }
    ...
    public var chatBar = KMChatChatBarConfiguration()
    ...
    public var navigationItemsForConversationList = [KMChatNavigationItem]() {
        didSet {
    ...
    public var navigationItemsForConversationView = [KMChatNavigationItem]() {
        didSet {
    ...
    public var messageMenuOptions: [KMChatMessageCell.MenuOption] = [.copy]
    ...
    /// After disabling you can handle it from outside by observing KMChatNotification.createGroupAction
    ...
    public var channelDetail = KMChatChannelDetailViewConfiguration()
   ...
   /// List of languages for speech to text.
    ...
    @available(*, deprecated, message: "Use navigationItemsForConversationList instead it has identifier in KMChatNavigationItem")
    public var nsNotificationNameForNavIconClick = "handleNavigationItemClick"

    /// Date cell and  information cell  background color
    @available(*, deprecated, message: "Use KMChatMessageStyle for customization.")
    public var conversationViewCustomCellBackgroundColor = UIColor.gray {
        didSet {
            let infoMessageStyle = KMChatMessageStyle.infoMessage
            let dateCellStyle = KMChatMessageStyle.dateSeparator
            KMChatMessageStyle.infoMessage = Style(font: infoMessageStyle.font, text: conversationViewCustomCellTextColor, background: conversationViewCustomCellBackgroundColor)
            KMChatMessageStyle.dateSeparator = Style(font: dateCellStyle.font, text: conversationViewCustomCellTextColor, background: conversationViewCustomCellBackgroundColor)
        }
    }
