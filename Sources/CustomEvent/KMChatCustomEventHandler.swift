//
//
// KMChatCustomEventHandler.swift
...
public class KMChatCustomEventHandler {
    public static let shared = KMChatCustomEventHandler()
    weak var delegate: KMChatCustomEventCallback?
     ...
     */
    public func setSubscribedEvents(eventsList: [KMCustomEvent], eventDelegate: KMChatCustomEventCallback) {
